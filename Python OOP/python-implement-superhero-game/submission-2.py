...
class FlightHero(Hero):
    def __init__(self, name, power_level, health, flight_speed: int):
        ...
        #super() get in charge of passing the self object (since we're inheritting from the parent class) which is the parent class, so no need to explicity state it
